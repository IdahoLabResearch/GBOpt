...
class Position:
    ...
    def __getitem__(self, index: Union[int, slice, str]) -> Union[float, Tuple[float, ...]]:
    ...
    def __mul__(self, other: numbers.Number) -> Position:
        if isinstance(other, numbers.Number):
            ...
            raise PositionTypeError("Operand must be a scalar value.")
    ...
    def __truediv__(self, other: numbers.Number) -> Position:
        if isinstance(other, numbers.Number) and other != 0:
            ...
            raise PositionTypeError("Operand must be a numeric value.")
